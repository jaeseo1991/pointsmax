...
const TOP_RATES = {
  ...
  amex_gold: ['dining: 4x', 'groceries: 4x', 'flights: 3x'], amex_plat: ['flights: 5x'],
  amex_bcp: ['groceries: 6x', 'subscriptions: 6x', 'gas: 3x'],
  cf: ['rotating 5x (Q2: Amazon, Chase Travel, Whole Foods)', '1x base'],
  cff: ['dining: 3x', 'flights/travel: 5x (Chase)', 'rotating 5x (Q2: Amazon, Chase Travel, Whole Foods)'],
  discover: ['rotating 5x (Q2: Restaurants, Home Improvement)', '1x base'],
  wfac: ['everything: 2x'], co_venture: ['all spend: 2x'],
