...
const CAT_ICONS = { dining: '🍽️', groceries: '🛒', flights: '✈️', travel: '🏨', gas: '⛽', shopping: '🛍️', subscriptions: '📱', entertainment: '🎬', other: '💳' };
const CAT_ORDER = ['dining', 'groceries', 'flights', 'travel', 'gas', 'shopping', 'subscriptions', 'entertainment', 'other'];
